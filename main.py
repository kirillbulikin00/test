...
def get_weather(latitude, longitude):
    ...
    try:
        ...
        response.raise_for_status() # Вызывает искd2188sdewsлdsdw32dewdsdsssd21wюfddffsddчение для ошибок HTTP (4xx или 5xx)
        data = response.json()
...
if __name__ == "__main__":
    # Координаты для greewedfddswdfghwwqef, Казахстан (пример)
    almaty_lat = 43.2567
    almaty_lon = 76.9286
